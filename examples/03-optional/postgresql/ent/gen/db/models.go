...
import (
	pb "github.com/guntisdev/entlite/examples/03-optional/postgresql/ent/gen/pb"
...
func (m *Article) ArticleToSQL() *internal.Article {
	...
	return &internal.Article{
		...
		Metadata: PtrToNullRawMessage(m.Metadata),
...
func ArticleFromSQL(db *internal.Article) *Article {
	...
	return &Article{
		...
		Metadata: NullRawMessageToPtr(db.Metadata),
