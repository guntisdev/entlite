...
What `entlite gen` writes from the schema above. See [`sqlite`](../../examples/03-optional/sqlite), [`postgresql`](../../examples/03-optional/postgresql), [`mysql`](../../examples/03-optional/mysql) for the other variants.
