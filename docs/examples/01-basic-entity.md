...
SELECT *, COUNT(*) OVER() AS total_count FROM "user" WHERE age BETWEEN @min_age AND @max_age AND name LIKE @name ORDER BY created_at LIMIT sqlc.arg('limit') OFFSET sqlc.arg('offset');
